...
char WIFINAME[] = "Moulik"; //enter your wifi name
char WIFI_PASS[] = "12345678"; //enter your wifi password
//cliwnt object
WiFiClient client;
...
//THIS IS THE CERTAIN CHART AND BASED ON THIS VALUES WILL BE PRINTED AND THE MESSAGE WILL BE MAILED
  ...
  {
    FORMAT_WEBHOOK_FUNCTION_CONNECTION("- Very bright",LIGHT_INTENSITY_VALUE);
